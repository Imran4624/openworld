  ...
  Iterable<Object?> serialize(Serializers serializers, UserState object,
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.filter,
          specifiedType: const FullType(UserFilter)),
    ];
    Object? value;
      ...
      switch (key) {
        ...
        case 'filter':
          result.filter.replace(serializers.deserialize(value,
              specifiedType: const FullType(UserFilter))! as UserFilter);
          break;
      }
    }
...
class _$UserState extends UserState {
  ...
  _$UserState._(
    ...
    BuiltValueNullFieldError.checkNotNull(filter, r'UserState', 'filter');
  }
...
class UserStateBuilder implements Builder<UserState, UserStateBuilder> {
  ...
  UserFilterBuilder? _filter;
  UserFilterBuilder get filter => _$this._filter ??= new UserFilterBuilder();
  set filter(UserFilterBuilder? filter) => _$this._filter = filter;
