...
abstract class SettingsEntity
  ...
  logError('unhandled entity type: $entityType for design id');
  ...
  String? getDefaultTerms(EntityType? entityType) {
    switch (entityType) {
      ...
      default:
  logError('getDefaultTerms not defined for $entityType');
        return '';
    }
  }
  ...
  String? getDefaultFooter(EntityType? entityType) {
    switch (entityType) {
      ...
      default:
  logError('getDefaultFooter not defined for $entityType');
        return '';
    }
  }
