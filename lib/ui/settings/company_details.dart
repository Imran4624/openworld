...
import 'package:flutter_boilerplate/redux/static/static_selectors.dart';
...
import 'package:flutter_boilerplate/ui/app/entity_dropdown.dart';
...
import 'package:flutter_boilerplate/ui/app/resources/cached_image.dart';
import 'package:flutter_boilerplate/ui/app/scrollable_listview.dart';
import 'package:flutter_boilerplate/ui/settings/company_details_vm.dart';
      ...
      body: AppTabForm(
        ...
        children: <Widget>[
                      ...
                      child: (state.isHosted && isWeb())
                          ? CachedImage(
                              ...
                              url: state.credentials.url +
                                  ...
                                  company.id +
                                  '/logo',
                              apiToken: 'Token' //state.userCompany.token.token,
                              )
                          : CachedImage(
                              width: double.infinity,
          ...
          ScrollableListView(
            primary: true,
            children: <Widget>[
              if (!state.isProPlan) FormCard(children: <Widget>[]),
              FormCard(
                isLast: true,
                children: <Widget>[],
              )
