    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(AppVersionEntity)));
    }
    return result;
  }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'companies':
          ...
          break;
        case 'appVersion':
          result.appVersion.replace(serializers.deserialize(value,
                  specifiedType: const FullType(AppVersionEntity))!
              as AppVersionEntity);
          break;
      }
...
class _$AppState extends AppState {
  ...
  @override
  final BuiltList<CompanyEntity> companies;
  @override
  ...
  _$AppState._(
    ...
    BuiltValueNullFieldError.checkNotNull(companies, r'AppState', 'companies');
  }
...
class AppStateBuilder implements Builder<AppState, AppStateBuilder> {
  ...
  ListBuilder<CompanyEntity>? _companies;
  ListBuilder<CompanyEntity> get companies =>
      _$this._companies ??= new ListBuilder<CompanyEntity>();
  set companies(ListBuilder<CompanyEntity>? companies) =>
      _$this._companies = companies;

  AppVersionEntityBuilder? _appVersion;
  AppVersionEntityBuilder get appVersion =>
      _$this._appVersion ??= new AppVersionEntityBuilder();
  set appVersion(AppVersionEntityBuilder? appVersion) =>
      _$this._appVersion = appVersion;
  ...
  AppStateBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _appVersion = $v.appVersion?.toBuilder();
      _$v = null;
    }
    return this;
  }
