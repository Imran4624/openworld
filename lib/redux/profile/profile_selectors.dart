...
var memoizedDropdownProfileList = memo5(
    (BuiltMap<String, ProfileEntity> profileMap,
            ...
            String? clientId) =>
        dropdownProfilesSelector(
            profileMap, profileList, staticState, userMap, clientId));
...
List<String> dropdownProfilesSelector(
  ...
  list.sort((profileAId, profileBId) {
    ...
    return profileA.compareTo(profileB, ProfileFields.name, true);
  });
...
var memoizedFilteredProfileList = memo4((SelectionState selectionState,
    ...
    filteredProfilesSelector(
        selectionState, profileMap, profileList, profileListState));
