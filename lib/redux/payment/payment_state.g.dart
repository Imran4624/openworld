  ...
  Iterable<Object?> serialize(Serializers serializers, PaymentState object,
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.filter,
          specifiedType: const FullType(PaymentFilter)),
      'isProcessingPayment',
      serializers.serialize(object.isProcessingPayment,
          specifiedType: const FullType(bool)),
      'processingMessage',
      serializers.serialize(object.processingMessage,
          specifiedType: const FullType(String)),
      'lastPaymentError',
      serializers.serialize(object.lastPaymentError,
          specifiedType: const FullType(String)),
    ];
    Object? value;
    ...
    value = object.lastPaymentResult;
    if (value != null) {
      result
        ..add('lastPaymentResult')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(Payment)));
    }
    value = object.lastPaymentIntent;
    if (value != null) {
      result
        ..add('lastPaymentIntent')
        ..add(serializers.serialize(value,
      ...
      switch (key) {
        ...
        case 'filter':
          result.filter.replace(serializers.deserialize(value,
              specifiedType: const FullType(PaymentFilter))! as PaymentFilter);
          break;
        case 'isProcessingPayment':
          result.isProcessingPayment = serializers.deserialize(value,
              specifiedType: const FullType(bool))! as bool;
          break;
        case 'processingMessage':
          result.processingMessage = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'lastPaymentResult':
          result.lastPaymentResult = serializers.deserialize(value,
              specifiedType: const FullType(Payment)) as Payment?;
          break;
        case 'lastPaymentIntent':
          result.lastPaymentIntent = serializers.deserialize(value,
              specifiedType: const FullType(PaymentIntent)) as PaymentIntent?;
          break;
        case 'lastPaymentError':
          result.lastPaymentError = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
      }
    }
...
class _$PaymentState extends PaymentState {
  ...
  @override
  final Payment? lastPaymentResult;
  @override
  final PaymentIntent? lastPaymentIntent;
  @override
  ...
  _$PaymentState._(
    ...
    BuiltValueNullFieldError.checkNotNull(filter, r'PaymentState', 'filter');
    BuiltValueNullFieldError.checkNotNull(
        isProcessingPayment, r'PaymentState', 'isProcessingPayment');
    BuiltValueNullFieldError.checkNotNull(
        processingMessage, r'PaymentState', 'processingMessage');
    BuiltValueNullFieldError.checkNotNull(
        lastPaymentError, r'PaymentState', 'lastPaymentError');
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is PaymentState &&
        ...
        filter == other.filter &&
        isProcessingPayment == other.isProcessingPayment &&
        processingMessage == other.processingMessage &&
        lastPaymentResult == other.lastPaymentResult &&
        lastPaymentIntent == other.lastPaymentIntent &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, isProcessingPayment.hashCode);
    _$hash = $jc(_$hash, processingMessage.hashCode);
    _$hash = $jc(_$hash, lastPaymentResult.hashCode);
    _$hash = $jc(_$hash, lastPaymentIntent.hashCode);
    _$hash = $jc(_$hash, lastPaymentError.hashCode);
    _$hash = $jf(_$hash);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'PaymentState')
          ...
          ..add('filter', filter)
          ..add('isProcessingPayment', isProcessingPayment)
          ..add('processingMessage', processingMessage)
          ..add('lastPaymentResult', lastPaymentResult)
          ..add('lastPaymentIntent', lastPaymentIntent)
          ..add('lastPaymentError', lastPaymentError))
        .toString();
  }
}
...
class PaymentStateBuilder
  ...
  PaymentFilterBuilder? _filter;
  PaymentFilterBuilder get filter =>
      _$this._filter ??= new PaymentFilterBuilder();
  set filter(PaymentFilterBuilder? filter) => _$this._filter = filter;

  bool? _isProcessingPayment;
  bool? get isProcessingPayment => _$this._isProcessingPayment;
  set isProcessingPayment(bool? isProcessingPayment) =>
      _$this._isProcessingPayment = isProcessingPayment;

  String? _processingMessage;
  String? get processingMessage => _$this._processingMessage;
  set processingMessage(String? processingMessage) =>
      _$this._processingMessage = processingMessage;

  Payment? _lastPaymentResult;
  Payment? get lastPaymentResult => _$this._lastPaymentResult;
  set lastPaymentResult(Payment? lastPaymentResult) =>
      _$this._lastPaymentResult = lastPaymentResult;

  PaymentIntent? _lastPaymentIntent;
  PaymentIntent? get lastPaymentIntent => _$this._lastPaymentIntent;
  set lastPaymentIntent(PaymentIntent? lastPaymentIntent) =>
      _$this._lastPaymentIntent = lastPaymentIntent;

  String? _lastPaymentError;
  String? get lastPaymentError => _$this._lastPaymentError;
  set lastPaymentError(String? lastPaymentError) =>
      _$this._lastPaymentError = lastPaymentError;
  ...
  PaymentStateBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _isProcessingPayment = $v.isProcessingPayment;
      _processingMessage = $v.processingMessage;
      _lastPaymentResult = $v.lastPaymentResult;
      _lastPaymentIntent = $v.lastPaymentIntent;
      _lastPaymentError = $v.lastPaymentError;
      _$v = null;
    }
    return this;
  }
    ...
    try {
      _$result = _$v ??
          new _$PaymentState._(
              ...
              filter: filter.build(),
              isProcessingPayment: BuiltValueNullFieldError.checkNotNull(
                  isProcessingPayment, r'PaymentState', 'isProcessingPayment'),
              processingMessage: BuiltValueNullFieldError.checkNotNull(
                  processingMessage, r'PaymentState', 'processingMessage'),
              lastPaymentResult: lastPaymentResult,
              lastPaymentIntent: lastPaymentIntent,
              lastPaymentError: BuiltValueNullFieldError.checkNotNull(
                  lastPaymentError, r'PaymentState', 'lastPaymentError'));
    } catch (_) {
