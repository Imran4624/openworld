...
class TakePayment implements StartSaving {
  TakePayment({
...
class CreatePaymentIntentAction implements StartSaving {
...
class ConfirmPaymentAction implements StartSaving {
...
class RefundPaymentAction implements StartSaving {
  RefundPaymentAction({
...
class PaymentLoadingAction implements StartLoading {
  PaymentLoadingAction([this.message]);
  final String? message;
}

class PaymentSuccessAction implements StopLoading, StopSaving {
  PaymentSuccessAction(this.result, [this.message]);
  final dynamic result;
  final String? message;
}

class PaymentFailureAction implements StopLoading, StopSaving {
  PaymentFailureAction(this.error);
  final String error;
}
