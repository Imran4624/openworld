...
import 'package:flutter_boilerplate/data/models/static/color_theme_model.dart';
...
abstract class PrefState implements Built<PrefState, PrefStateBuilder> {
  factory PrefState() {
    return _$PrefState._(
      ...
      donwloadsFolder: '',
      statementIncludes: BuiltList(<String>[]),
  ...
  static void _initializeBuilder(PrefStateBuilder builder) => builder
    ..statementIncludes.replace(BuiltList<String>(<String>[]))
