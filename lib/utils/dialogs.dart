...
import 'package:flutter_boilerplate/ui/app/forms/custom_field.dart';
import 'package:flutter_boilerplate/ui/app/forms/design_picker.dart';
        ...
        builder: (context, setState) {
          void _onPressed() {
            if (typeToConfirm == null ||
              ...
              String finalReason = '';
              if (askForReason) {
                if (_selectedReason == 'Other' && _customReason.isNotEmpty) {
                  finalReason = _customReason;
                } else if (_selectedReason.isNotEmpty) {
                  finalReason = _selectedReason;
                }
              }

              callback(finalReason.isEmpty ? null : finalReason);
            } else {
              showMessageDialog(
                      ...
                      children: [
                        ...
                        if (askForReason) ...[
                          ...
                          AppDropdownButton<String>(
                            ...
                            items: ProjectConfig.accountDeletedReason
...
void showChangePasswordDialog({
  required BuildContext context,
  required Function(String? oldPassword, String? newPassword) callback,
  String? message,
}) {
  ...
  void _onSubmit() {
    if (_newPasswordController.text != _confirmPasswordController.text) {
      showErrorDialog(
        message: localization!.confirmPasswordError,
      );
      return;
    }

    Navigator.pop(context); // Close the dialog
    callback(_oldPasswordController.text, _newPasswordController.text);
  }
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration:
                  InputDecoration(labelText: localization.confirmPassword),
              obscureText: true,
            ),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            if (_isLoading) ...[
              ...
              if ((_field ?? '').contains('custom_value'))
                CustomField(
