            ...
            completer.future.then((_) {
              ...
              if (loadedEntity != null) {
                if (ProjectConfig.appType == AppType.opw &&
                  ...
                  final entityTypes = loadedEntity.entityType!.relatedTypes
                      .where((entityType) =>
  ...
  checkForChanges(
      ...
      callback: () {
        ...
        switch (entityType) {
          ...
          case EntityType.payment:
            store.dispatch(EditPayment(
                payment: entity as PaymentEntity, completer: completer));
            break;
  ...
  if ([
    ...
    if (isMobile(navigatorKey.currentContext!)) {
      ...
      switch (entities.first.entityType) {
        ...
        default:
          logError('${entities.first.entityType} entity type not supported');
      }
    }
  }
