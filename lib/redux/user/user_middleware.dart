...
import 'package:flutter_boilerplate/ui/user/edit/user_edit_vm.dart';
...
Middleware<AppState> _archiveUser(UserRepository repository) {
  return (Store<AppState> store, dynamic dynamicAction, NextDispatcher next) {
    ...
    repository
      ...
      logError(' ArchiveUser error: $error');
...
Middleware<AppState> _restoreUser(UserRepository repository) {
  return (Store<AppState> store, dynamic dynamicAction, NextDispatcher next) {
    ...
    repository
      ...
      logError(' RestoreUser error: $error');
...
Middleware<AppState> _removeUser(UserRepository repository) {
  return (Store<AppState> store, dynamic dynamicAction, NextDispatcher next) {
    ...
    repository
      ...
      logError(' RemoveUser error: $error');
...
Middleware<AppState> _resendInvite(UserRepository repository) {
  return (Store<AppState> store, dynamic dynamicAction, NextDispatcher next) {
    ...
    repository
      ...
      logError(' ResendInvite error: $error');
  ...
  return (Store<AppState> store, dynamic dynamicAction, NextDispatcher next) {
    ...
    repository.loadList(state.credentials).then((data) {
      ...
      */
      ...
      logError(' LoadUsers error: $error');
