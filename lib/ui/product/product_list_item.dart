...
class ProductListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final filterMatch =
        filter?.isNotEmpty == true ? product.matchesFilterValue(filter!) : null;
    ...
    return DismissibleEntity(
      ...
      child: ListTile(
        onTap: () => onTap != null ? onTap!() : selectEntity(entity: product),
        ...
        title: SizedBox(
          ...
          child: Row(
            children: <Widget>[
              ...
              Text(
                formatNumber(product.listDisplayAmount, context)!,
                style: Theme.of(context).textTheme.titleMedium,
              ),
            ],
          ),
