...
import 'package:flutter_boilerplate/data/models/design_model.dart';
import 'package:flutter_boilerplate/ui/app/app_webview.dart';
...
import 'package:flutter_boilerplate/ui/app/variables.dart';
import 'package:flutter_boilerplate/ui/design/edit/design_edit_vm.dart';
import 'package:flutter_boilerplate/utils/completers.dart';
import 'package:flutter_boilerplate/utils/designs.dart';
      ...
      children: <Widget>[
        FormCard(
          children: <Widget>[
            ...
            if (!kReleaseMode || isWeb() || isMobileOS())
              SwitchListTile(
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: <Widget>[
          if (widget.pdfBytes == null)
            SizedBox()
          else if (isWeb() && state.prefState.enableNativeBrowser)
